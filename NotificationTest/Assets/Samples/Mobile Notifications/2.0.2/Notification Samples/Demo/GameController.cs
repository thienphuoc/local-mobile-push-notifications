...
namespace NotificationSamples.Demo
{
    ...
    public class GameController : MonoBehaviour
    {
        ...
        public void OnPlayReminder()
        {
            ...
            //DateTime deliveryTime = DateTime.Now.ToLocalTime().AddSeconds(30);

            DateTime deliveryTime = DateTime.Now.ToLocalTime();

            deliveryTime = deliveryTime.AddSeconds(15);

            //deliveryTime = new DateTime(deliveryTime.Year, deliveryTime.Month, deliveryTime.Day, deliveryTime.Hour, 0, 0,
            //    DateTimeKind.Local);

           // console.SendNotification("PhuocCookieReminder", "PhuocRemember to make more cookies:" + $"{deliveryTime}", deliveryTime,
