...
namespace NotificationSamples.Demo
{
    ...
    public class NotificationConsole : MonoBehaviour
    {
        ...
        public const string ChannelId = "game_channel3";
        public const string ReminderChannelId = "reminder_channel3_phuoc";
        public const string NewsChannelId = "news_channel3";
            ...
            string smallIcon = null, string largeIcon = null)
        {
            ...
            QueueEvent($"Queued event with ID \"{notification.Id}\" at time {deliveryTime}");
        }
        ...
        {
            QueueEvent($"Notification with title \"{obj.Notification.Title}\" expired and was not displayed. Time:{obj.Notification.DeliveryTime} Now:{DateTime.Now}");
        }
