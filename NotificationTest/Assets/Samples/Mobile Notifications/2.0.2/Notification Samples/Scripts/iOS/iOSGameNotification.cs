...
namespace NotificationSamples.iOS
{
    ...
    public class iOSGameNotification : IGameNotification
    {
        ...
        public DateTime? DeliveryTime
        {
            get
            {
                ...
                var result = new DateTime
                    (
                     calendarTrigger.Year.Value,
                    calendarTrigger.Month.Value,
                    calendarTrigger.Day.Value,
                    calendarTrigger.Hour.Value,
                    calendarTrigger.Minute.Value,
                    calendarTrigger.Second.Value,
                    DateTimeKind.Local
                    );
        ...
        /// </summary>
        public string CategoryIdentifierCategoryIdentifier
        {
